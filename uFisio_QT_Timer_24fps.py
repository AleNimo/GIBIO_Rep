...
class Thread_Lectura(QThread):
    ...
    def run(self) -> None:
        global acceso_datos, cond, draw_IR, draw_RED, paquete, cont_ppg, cont_draw, cond_rec, datos_IR, datos_RED, data_on, window, now, lastupdate, fps, fps2, dec, data_modif
